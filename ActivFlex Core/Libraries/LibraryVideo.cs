...
{
    /// <summary>
    /// Represents a media library item that stores video data.
    /// Notice that changes will not update the media container.
    /// </summary>
    public class LibraryVideo : MediaVideo, ILibraryItem
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a new library video for the first time. This constructor will not insert
        ...
        /// <summary>
        /// Create a new library video instance for an existing item. This constructor should
        ...
        public LibraryVideo(int itemID, string name, string path, MediaContainer container,
                            ulong accessCount, StarRating rating, DateTime creationTime, DateTime lastAccessTime, BitmapSource thumbnail) : base(path, name)
        {
            this.ItemID = itemID;
            this.Container = container;
